...
import { PropRow, NumberInput, AcceptChips, FileFillInput, AiExtractToggle } from "./widgets";
...
function Properties({ field: f, patch }: FieldPropsEditorProps) {
  return (
    <div className="space-y-3">
      ...
      <AiExtractToggle field={f} patch={patch} />
    </div>
  );
}
...
export const fileField: FieldTypeDef = {
  ...
  icon: PaperclipIcon,
  order: 6,
  ownProps: ["maxFiles", "accept", "aiExtract"],
