...
export default tseslint.config(
  ...
  },
  {
    ...
    // interactive/checkpoints 同理(互动游戏编辑器·关卡类型注册表)。
    files: ["src/features/task/fields/*.tsx", "src/features/report/fields/*.tsx", "src/features/showcase/tools/*.tsx", "src/features/interactive/games/*.tsx", "src/features/interactive/checkpoints/*.tsx"],
    rules: {
      "react-refresh/only-export-components": "off",
    },
  },
