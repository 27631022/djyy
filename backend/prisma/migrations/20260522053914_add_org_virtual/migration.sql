...
INSERT INTO "new_Organization" ("active", "code", "createdAt", "id", "kind", "meta", "name", "parentId", "sortOrder", "type", "updatedAt") SELECT "active", "code", "createdAt", "id", "kind", "meta", "name", "parentId", "sortOrder", "type", "updatedAt" FROM "Organization";
